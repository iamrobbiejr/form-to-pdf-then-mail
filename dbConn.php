...
$connect = mysqli_connect($server,$username,$password) or die(mysqli_error("Connection Failed"));

//Select Database
mysqli_select_db($connect,$database) or die(mysqli_error("Database not selected"));
...
//data insertion Querries
//insert into applicants table
$sql = "INSERT INTO `applicants` (`fname` ,`mname`,`lname`,`dob`,`address`,`gender`,`nat_id`,`mobile`,`email`,`tel`,`property`,`los`)VALUES (' ".$fname." ','".$mname."' ,' ".$lname." ','".$dob."', ' ".$address." ', '".$gender."','".$nat_id."','".$mobile."','".$email."','".$tel."','".$property."','".$los."')";
//insert into assets table
$sqlA = "INSERT INTO `assets` (`assetName`,`serialNo`,`value`) VALUES ('".$assetName."','".$serialNo."','".$value."')";
//insert into bankingdetails table
$sqlB = "INSERT INTO `bankingdetails` (`bankName`,`branch`,`accNum`) VALUES ('".$bankName."','".$branch."','".$accNum."')";
//insert into employment table
$sqlE = "INSERT INTO `employment` (`empName`,`empAddress`,`empCell`,`empEmail`,`jobTitle`,`grossSalary`,`dateEmployed`) VALUES ('".$empName."','".$empAddress."','".$empCell."','".$empEmail."','".$jobTitle."','".$grossSalary."','".$dateEmployed."')";
//insert into financialInfo table
$sqlF = "INSERT INTO `financialinfo` (`loanAmnt`,`repaymentSource`,`purpose`,`lender`,`outstandingAmnt`,`installment`) VALUES ('".$loanAmnt."','".$repaymentSource."','".$purpose."','".$lender."','".$outstandingAmnt."','".$installment."')";

 $result = mysqli_query($connect,$sql) or die(mysql_error());
 $result1 = mysqli_query($connect,$sqlE) or die(mysql_error());
 $result2 = mysqli_query($connect,$sqlF) or die(mysql_error());
  $result3 = mysqli_query($connect,$sqlA) or die(mysql_error());
  $result4 = mysqli_query($connect,$sqlB) or die(mysql_error());
...
$pdf->Cell(40,10, "Loan Application for:",1,1,'C');
$pdf->Cell(40,10, $fname ,1,2);
$pdf->Cell(40,10,$lname,1,3);
...
$pdf->Cell(40,10,"Cell:",0,1);
$pdf->Cell(40,10,$mobile,0,1);
...
$pdf->Cell(40,10,"Contact:	",0,0);
$pdf->Cell(40,10,"Cell:",0,1);
$pdf->Cell(40,10,$empCell,0,1);
$pdf->Cell(40,10,"Email:",0,1);
$pdf->Cell(40,10,$empEmail,0,1);
...
$pdf->Cell(40,10,"Lender: ",0,0);
$pdf->Cell(40,10,$lender,0,1);
$pdf->Cell(40,10,"Outstanding: ",0,1);
$pdf->Cell(40,10,$outstandingAmnt,0,1);
$pdf->Cell(40,10,"Monthly Installments:",0,2);
$pdf->Cell(40,10,$installment,0,2);
...
$pdfdoc = $pdf->Output('application.pdf', 'S');
...
mail($to, $subject, "", $headers);
 ...
 header('Location: http://localhost/testingSite/success.php');
